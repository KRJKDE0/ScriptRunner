...
def baseurl = "JenkinsURL/buildByToken/buildWithParameters?job=auto_actionitems/dbauto_actionitems_single_ticket&token=singletickettoken&environment=all_lower&ticket=${issuekey}&email=${issueReporterMail}&cause=jira_workflow_trigger"
